...
2. **Book Structure Overview** - Front/main/back matter summary
3. **Cultural Context Analysis** - AI-powered insights
4. **AI Voice Recommendations** - 4 voices with match percentages
5. **Chapter Details** - Full chapter list with word counts
6. **Project File Structure** - Folder tree with sizes
...
2. Verify you're using V13.1 (not V13 or V12)
3. Include:
